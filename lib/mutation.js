...
function (_PureComponent) {
  _inherits(Mutation, _PureComponent);
  ...
  function Mutation() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Mutation)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "sendRequest", function (uri, method, options, onResponse, onError) {
      if (!uri) {
    ...
    value: function render() {
      ...
      return children({
        mutate: function mutate(_ref) {
          ...
          return _this2.sendRequest(uri, method, options, onResponse, onError);
        }
      });
    }
  }]);
